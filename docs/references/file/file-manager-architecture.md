...
FileManager is the **sole public entry point of the FileEntry management system** but is not a 30-method God class. The implementation uses a **facade + private pure-function modules** pattern. (Note: "sole public entry" is scoped to FileEntry; see [architecture.md §1.2](./architecture.md#12-filemanagers-position-within-the-module).)
