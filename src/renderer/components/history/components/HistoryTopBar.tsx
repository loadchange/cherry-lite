...
const HistoryTopBar = ({
  ...
  const canBulkMove = selectedCount > 0 && moveTargets.length > 0 && !!onBulkMove
  const deleteTitle = t('history.records.bulkDeleteTopics.title')
  const deleteDescription = t('history.records.bulkDeleteTopics.description', { count: bulkDeleteCount })
