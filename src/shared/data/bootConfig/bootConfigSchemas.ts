 ...
 * Boot config schema.
 *
 * Edit this file directly. The former classification.json generator has been removed.
 * The zod schema is the single source of truth: the BootConfigSchema type is inferred
 * from it, and BootConfigService validates file/set values against it at runtime.
 */
